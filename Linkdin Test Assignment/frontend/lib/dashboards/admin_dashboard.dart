// lib/dashboards/admin_dashboard.dart (FINAL VERSION with Image Picker)
...
class _AdminDashboardPageState extends State<AdminDashboardPage> {
  ...
  void initState() {
    ...
    _orderCountTimer = Timer.periodic(const Duration(seconds: 30), (_) {
      if (mounted) fetchNewOrdersCount();
    });
  ...
  Future<void> exportCSV() async {
    if (!kIsWeb) {
      TopPopup.show(context, "CSV export is only available on web", Colors.orange);
      return;
    }
    if (products.isEmpty) {
      TopPopup.show(context, "No products to export", Colors.orange);
      return;
    }
    final rows = <List<dynamic>>[
      ["ID", "Name", "Price", "Stock", "Status", "Reviews", "Rating"]
    ];
    ...
    TopPopup.show(context, "CSV ready — integrate with universal_html for download",
        accentGreen);
  }
                ...
                if (image != null) {
                  setState(() {
                    ...
                    if (kIsWeb) {
                      ...
                      // For mobile, you might want to upload to server and get URL
                      imageCtrl.text = image.path;
                      // Note: In production, you'd upload to server here
                      TopPopup.show(
                        context,
                        "Image selected. In production, upload to server",
                        accentGreen,
                      );
                    }
                  });
                ...
                if (image != null) {
                  setState(() {
                    ...
                    if (kIsWeb) {
                      ...
                      TopPopup.show(
                        context,
                        "Photo captured. In production, upload to server",
                        accentGreen,
                      );
                    }
                  });
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  buildTextField(descCtrl, "Description", readOnly, isSmall,
                      maxLines: 3),
                  SizedBox(height: isSmall ? 10 : 12),
                  buildTextField(priceCtrl, "Price (Rs)", readOnly, isSmall,
                      keyboard: TextInputType.number),
                  SizedBox(height: isSmall ? 10 : 12),
                  buildTextField(stockCtrl, "Stock Quantity", readOnly, isSmall,
                      keyboard: TextInputType.number),
                  SizedBox(height: isSmall ? 10 : 12),
  ...
  Widget buildTextField(TextEditingController c, String label, bool readOnly,
      bool isSmall,
  ...
  // ✅ UPDATED PRODUCT CARD - Large review button on top, two buttons below
          ...
          child: Card(
            ...
            child: LayoutBuilder(
              builder: (context, constraints) {
                ...
                final bool isUltraCompact = cardWidth < 180; // Increased threshold for wider cards

                // 📏 LARGER CARD SIZES
                final double imgH = isUltraCompact ? 100 : (isSmall ? 120 : 140);
                final double pad = isUltraCompact ? 8 : (isSmall ? 10 : 12);
                final double btnPad = isUltraCompact ? 8 : (isSmall ? 10 : 12);
                final double nameSz = isUltraCompact ? 13 : (isSmall ? 14 : 16);
                final double prSz = isUltraCompact ? 13 : (isSmall ? 14 : 16);
                final double ratSz = isUltraCompact ? 11 : (isSmall ? 12 : 13);
                final double iconSz = isUltraCompact ? 14 : (isSmall ? 16 : 18);
                final double btnSz = isUltraCompact ? 12 : (isSmall ? 13 : 14);
                ...
                return Column(
                  ...
                  children: [
                              ...
                              ? Image.network(
                                  ...
                                  errorBuilder: (_, __, ___) => Container(
                                    ...
                                    child: Icon(Icons.shopping_bag_outlined,
                                        size: isUltraCompact ? 40 : (isSmall ? 48 : 56),
                                        color: mediumGrey),
                                  ),
                                )
                              : Container(
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          // Description
                          if (!isUltraCompact && product.description.isNotEmpty) ...[
                            const SizedBox(height: 4),
                            Text(
                              product.description,
                              maxLines: 2,
                    ...
                    // Action Buttons - Large Review on top, Edit+Delete below in one line
                    Padding(
                      padding: EdgeInsets.fromLTRB(pad, 8, pad, pad),
                      child: Column(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          // 1. LARGE REVIEW BUTTON (full width)
                          SizedBox(
                            width: double.infinity,
                            ...
                            child: ElevatedButton.icon(
                              ...
                              style: ElevatedButton.styleFrom(
                                backgroundColor:
                                    product.reviewCount > 0 ? Colors.purple : Colors.grey,
                          ...
                          // 2. EDIT + DELETE BUTTONS IN ONE LINE
                          Row(
                            children: [
                              Expanded(
                                child: SizedBox(
                                  ...
                                  child: ElevatedButton.icon(
                                    onPressed: () async {
                                      ...
                                      if (ok) {
                                        fetchProducts();
                                        TopPopup.show(
                                            context, "Product deleted!", Colors.red);
                                      }
                                    },
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  constraints: BoxConstraints(
                      minWidth: w < 350 ? 14 : 16, minHeight: w < 350 ? 14 : 16),
                  child: Center(
                      child: Text('$badge',
                          style: TextStyle(
                              color: Colors.white,
          ...
          children: [
            ...
            _drawerItem(Icons.notifications, "Alerts & Notifications", () async {
              ...
              await Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (_) =>
                          NotificationsPage(token: widget.token, isAdmin: true)));
              _loadNotificationCount();
            ...
            _drawerItem(Icons.people, "User Management", () {
              ...
              Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (_) =>
                          UsersPage(token: widget.token, currentUserId: widget.userId)));
            }),
            _drawerItem(Icons.shopping_cart, "Manage Orders", () async {
              ...
              await Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (_) => AdminOrdersPage(token: widget.token)));
              fetchNewOrdersCount();
              fetchProducts();
            ...
            _drawerItem(Icons.local_offer, "Manage Coupons", () {
              ...
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (_) => AdminCouponsPage(token: widget.token)));
            }),
            _drawerItem(Icons.rate_review, "Manage Reviews", () {
              ...
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (_) => AdminReviewsPage(token: widget.token)));
            }),
            const Divider(),
  ...
  Widget build(BuildContext context) {
    ...
    // ✅ WIDER CARDS - Better aspect ratios for larger cards
    final int prodCols = isSmartwatch || isVerySmall ? 1 : isSmall ? 2 : isTablet ? 3 : 5;
    final double prodAspect = isSmartwatch ? 0.6 : isVerySmall ? 0.65 : isSmall ? 0.7 : 0.75;
      ...
      appBar: AppBar(
        ...
        actions: [
          if (w >= 600) ...[
            ...
            navButton(Icons.people, "Users", () => Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (_) =>
                        UsersPage(token: widget.token, currentUserId: widget.userId)))),
            ...
            navButton(Icons.local_offer, "Coupons", () => Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (_) => AdminCouponsPage(token: widget.token)))),
            navButton(Icons.rate_review, "Reviews", () => Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (_) => AdminReviewsPage(token: widget.token)))),
          ],
              ...
              child: Column(
                ...
                children: [
                  ...
                  LayoutBuilder(builder: (lbCtx, bc) {
                    ...
                    final cards = [
                      analyticsCard(
                          "Total Products", "$_totalProducts", Icons.inventory_2, accentGreen),
                      analyticsCard("In Stock", "$_inStock", Icons.check_circle, Colors.blue),
                      analyticsCard("Low Stock", "$_lowStock", Icons.warning_amber_rounded,
                          Colors.orange),
                      analyticsCard("Out of Stock", "$_outOfStock", Icons.remove_shopping_cart,
                          Colors.red.shade600),
                    ...
                    return Wrap(
                      ...
                      children:
                          cards.map((c) => SizedBox(width: cardW, height: cardH, child: c)).toList(),
                    );
                  }),
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                            prefixIcon: Icon(Icons.search,
                                color: mediumGrey, size: isSmartwatch ? 16 : 20),
                            hintText: isSmartwatch ? "Search" : "Search products",
                            hintStyle:
                                TextStyle(color: mediumGrey, fontSize: isSmartwatch ? 11 : 14),
                            filled: true,
                            fillColor: white,
                            border: OutlineInputBorder(
                              borderRadius: BorderRadius.circular(8),

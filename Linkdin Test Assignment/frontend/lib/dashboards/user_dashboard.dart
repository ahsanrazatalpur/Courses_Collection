// lib/dashboards/user_dashboard.dart (FINAL VERSION)
...
class _UserDashboardState extends State<UserDashboard> {
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    icon: Icon(
                      reviewCount > 0 ? Icons.rate_review : Icons.rate_review_outlined,
                      size: 18,
                    ),
                    label: Text(
                      "Reviews ($reviewCount)",
                  ...
                  child: Padding(
                    ...
                    child: LayoutBuilder(
                      builder: (context, constraints) {
                        ...
                        // 📏 WIDER CARD SIZES
                        final double imgH = isSmall ? 110 : 130;
                        final double pad = isSmall ? 8 : 10;
                        final double nameSz = isSmall ? 13 : 15;
                        final double prSz = isSmall ? 13 : 15;
                        final double ratSz = isSmall ? 11 : 12;
                        ...
                        return Column(
                          ...
                          children: [
                            ...
                            Stack(
                              children: [
                                buildProductImage(product.image,
                                    height: imgH, isSmall: isSmall),
                                Positioned(
                                  top: 6,
                                  right: 6,
                                  child: _buildStockBadgeCompact(stock),
                                ),
                              ],
                            ),
                            SizedBox(height: pad),
                            ...
                            // 2. CART + BUY BUTTONS IN ONE LINE
                            Row(
                              children: [
                                Expanded(
                                  child: SizedBox(
  ...
  // Compact stock badge
  Widget _buildStockBadgeCompact(int stock) {
    Color badgeColor;
    String text;
    if (stock == 0) {
      badgeColor = Colors.red;
  ...
  Widget build(BuildContext context) {
    ...
    // ✅ WIDER CARDS - Better aspect ratios
